...
class CommonCrawlDomainFilter:
    ...
    DEFAULT_DENYLIST: frozenset[str] = frozenset(
        {
            ...
            "ikea.com",
            "zara.com",
            # ── Platform storefronts (never direct clients) ───────────────────
            "myshopify.com",
            "squarespace.com",
            "wixsite.com",
            "webflow.io",
            "bigcartel.com",
            # ── News / media (not ecommerce) ──────────────────────────────────
            "spiegel.de",
            "bild.de",
            "welt.de",
            "faz.net",
    ...
    # Substring tokens that appear in enterprise, news, adult, or non-ecommerce hostnames
    BLOCKED_SUBSTRING_TOKENS: tuple[str, ...] = (
        # Enterprise / holding structures
        "marketplace",
        "wikipedia",
        "github",
        "corp",
        ...
        "ratgeber",
        "magazin",
        # Blog / community / support (subdomain-style matches)
        "forum.",
        ".forum",
        "community.",
        "support.",
        ...
        "ministerium",
        "verwaltung",
        # Adult / 18+ content — blocked at discovery level
        "porn",
        "xvideos",
        "xnxx",
        "youporn",
